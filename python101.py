...
# Global variable (don't want all global variables in your global scope)
x = 3
def calc():

	global x 	# ****** Can add to the top and will look for x at the next level up

	x is now local
	x = x + 3	#Will not print because it's trying to add nothing to 3

	print x 	#This would print 3 alone since it is the global variable

	x = 5
	print x		#This would print 5 because it is the lobal variable within the function
calc()
print x 		#This would print 3 since it doesn't know about the local variable
